...
import { Smile,ThumbsUp,MessageSquareMore,Forward ,X,SendHorizonal,ChevronDown } from "lucide-react"
...
const OtherProfile = () => { 
  ...
  function handleCommentClick(postid){ 
    ...
    .then(res=>{setComments(res.data.post.comments);console.log(res.data)})
    .catch(err=>{console.log(err)})
  }
